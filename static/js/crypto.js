...
class CryptoManager {
  ...
  static async decryptMessage(encryptedMessage, symmetricKey) {
    try {
      ...
      console.log(
        "Attempting to decrypt message of length:",
  ...
  static async encryptFile(file, symmetricKey, onProgress = null) {
    try {
      ...
      console.log(
        "File loaded into buffer successfully, size:",
        buffer.byteLength,
      );
      ...
      console.log(
        "File encrypted successfully, size:",
      ...
      combined.set(encryptedArray, iv.length);
      console.log(
        "Combined IV and encrypted data, total size:",
        combined.length,
      );
  ...
  static async decryptFile(
    ...
    try {
      ...
      console.log(
        "Data decrypted successfully, size:",
      ...
      if (error.name === "OperationError") {
        ...
        errorMessage =
          "File appears to be corrupted or not properly encrypted.";
      }
